...
[![My Skills](https://skillicons.dev/icons?i=atom,arduino,aws,bash,c,cpp,discord,eclipse,express,gcp,git,github,gitlab,java,js,html,css,nodejs,linux,matlab,mysql,pytorch,replit,tensorflow,vim,vscode&perline=6)](https://skillicons.dev)
